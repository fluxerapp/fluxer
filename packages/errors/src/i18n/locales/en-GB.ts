...
const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	"phone.number_not_in_service": "Your mobile network says this number isn't in service. Check the number and try again, or email support@fluxer.app if it's correct.",
