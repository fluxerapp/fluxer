...
export type AccessibilitySettings = Message<"fluxer.user.preferences.v1.AccessibilitySettings"> & {
  ...
  /**
   * @generated from field: optional bool double_click_message_actions = 64;
   */
