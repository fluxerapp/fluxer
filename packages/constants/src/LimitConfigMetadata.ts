...
export const LIMIT_KEY_SCOPES: Record<LimitKey, LimitScope> = {
	...
	max_poll_question_length: 'both',
	max_poll_answers: 'both',
	max_poll_answer_length: 'both',
	max_poll_votes_per_answer: 'both',
...
export const LIMIT_KEY_METADATA: Record<LimitKey, LimitKeyMetadata> = {
	...
	max_poll_question_length: {
		...
		description: 'Maximum number of characters for poll questions',
		category: 'messages',
		scope: 'both',
		isToggle: false,
		unit: 'count',
	...
	max_poll_answers: {
		...
		description: 'Maximum number of answers in polls',
		category: 'messages',
		scope: 'both',
		isToggle: false,
		unit: 'count',
	...
	max_poll_answer_length: {
		...
		description: 'Maximum number of characters per answer in polls',
		category: 'messages',
		scope: 'both',
		isToggle: false,
		unit: 'count',
	...
	max_poll_votes_per_answer: {
		...
		label: 'Max Poll Votes Per Answer',
		description: 'Maximum number of votes per answer in polls',
		category: 'messages',
		scope: 'both',
		isToggle: false,
		unit: 'count',
