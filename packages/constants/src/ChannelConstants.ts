...
export const PermissionsDescriptions: Record<keyof typeof Permissions, string> = {
	...
	CREATE_PUBLIC_THREADS: 'Allows creating public threads in a channel',
	CREATE_PRIVATE_THREADS: 'Allows creating private threads in a channel',
	CREATE_THREADS: 'Allows creating threads in a channel (alias for CREATE_PUBLIC_THREADS)',
