...
export class MessagePersistenceService {
	...
	async updateMessage(params: {
		...
		const hasOnlyAutoGeneratedEmbeds = message.embeds.every((embed) => embed.type !== 'rich');
		if (allowEmbeds && (data.embeds !== undefined || (data.content !== undefined && hasOnlyAutoGeneratedEmbeds))) {
