...
<sup>1</sup> Fluxer keeps no session-start ledger, so neither a request nor an Identify changes either value

<sup>2</sup> 14400000 ms is four hours, and Fluxer runs no timer against it
